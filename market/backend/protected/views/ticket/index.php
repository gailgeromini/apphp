                ...
                <fieldset class="form">
                    ...
                    <div class="actions">
                        <div class="controls">
                            ...
                            <span>or</span>
                            <input name="action" type="submit" value="View All" class="btn" onclick="javascript: if (!confirm('Are you sure you want to show all ticket without any condition?')) { return false; }">
                        </div>
                    </div>
                </fieldset>
            </form>
