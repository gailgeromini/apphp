				...
				<header>
					...
					<div class="field" style="border-bottom:none;">
						...
						<div style="float:left">
						    <input type="submit" name="btn" class="btn action" value="Comment">
						    <input type="submit" name="btn" class="btn" value="Replacement" onclick="javascript: if (!confirm('Are you sure you want to replacement this item(s) to user ?')) { return false; }">
						</div>
					</fieldset>
					</form>
					<?php }?>
