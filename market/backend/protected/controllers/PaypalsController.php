...
class PaypalsController extends CController
{
    ...
    public function __construct()
    {
        ...
        $this->view->setMetaTags('title', 'Admin Paypal');
        $this->view->activeLink = 'paypals' ;
    }
    ...
    public function indexAction($page = null)
    {
        ...
        $this->view->targetPath = 'paypals/index';
        ...
        $this->view->render('paypals/index');
