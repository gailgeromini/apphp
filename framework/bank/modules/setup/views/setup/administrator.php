...
<?php
    echo CWidget::form(array(
        ...
        'fields'=>array(
            ...
            'email'=>array('type'=>'textbox', 'value'=>$email, 'label'=>'Email', 'mandatoryStar'=>false, 'htmlOptions'=>array('maxLength'=>'70', 'autocomplete'=>'off')),
            'username'=>array('type'=>'textbox', 'value'=>$username, 'label'=>'Username', 'mandatoryStar'=>true, 'htmlOptions'=>array('maxLength'=>'32', 'autocomplete'=>'off')),
            'password'=>array('type'=>'password', 'value'=>$password, 'label'=>'Password', 'mandatoryStar'=>true, 'htmlOptions'=>array('maxLength'=>'20', 'autocomplete'=>'off')),
        ),
        'buttons'=>array(
